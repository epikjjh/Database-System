...
test_case_seq("Medium(2^13)", MEDIUM_CASE)
test_case_seq("Large(2^15)", LARGE_CASE)

print("--------------   Random Insert Test   --------------")
test_case_rnd("Small(2^10)", SMALL_CASE)
test_case_rnd("Medium(2^13)", MEDIUM_CASE)
test_case_rnd("Large(2^15)", LARGE_CASE)
...
test_delete_random("Random_Delete_Medium(2^13)", MEDIUM_CASE)
test_delete_random("Random_Delete_Large(2^14)", int(LARGE_CASE / 2))
test_delete_random("Random_Delete_ALL(2^15)", LARGE_CASE)
